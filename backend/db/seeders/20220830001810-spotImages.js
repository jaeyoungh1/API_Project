  ...
  async up(queryInterface, Sequelize) {
    ...
    */
    await queryInterface.bulkInsert('SpotImages', [
      ...
      {
        spotId: 1,
        url: "https://images.unsplash.com/photo-1631756964162-25c8c07579b5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
        preview: false
      },
      {
        spotId: 2,
